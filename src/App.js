/*
Description: Browser Plugin for the Surf Phish Detection API.
...
function scan(e) {
  ...
  let payload = {
    ...
    'screenshot': true,
    // Must set these to true, so that the report will be saved properly.
    'url_parsed': true,
    'whois_query': true,
    'whois_parsed': true,
    'html': true,
  ...
  fetch('https://engine.deep.surf/api/v1/scanner/scan-plugin', {
    method: 'POST',
  ...
  return (
    <div className="App">
      <header className="App-header">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="mt-1 bi bi-tsunami" viewBox="0 0 16 16">
        ...
        <div id="content">
          ...
          <form onSubmit={scan} id="scanForm">
            ...
            <button className="d-inline-block mt-1 submit-btn bg-main rounded-pill shadow" type="submit">
          ...
          <div id="report" className="hide">
            {/* prediction */}
            <h4 className="p-2 mt-0">
              <span id="prediction" className="pill rounded-pill bg-dark">
              </span> 
